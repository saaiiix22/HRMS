...
const ViewMonthlyAttendance = () => {
  ...
  return (
    <div className='p-4 bg-white mt-3 rounded-md border border-[#ccc]'>
      <form onSubmit={formik.handleSubmit}>
        <div className="">
          <h3 className="text-black text-[15px] font-semibold">
            Biometric <span className="text-slate-500">Attendance</span>
          </h3>
      ...
      <p className='text-center my-5 text-red-500 text-sm'>No excel file for attendance for the selected month & year is yet uploaded.*</p>
      <div className='flex justify-center w-100'>
        <button className='px-3 py-2 bg-blue-500 text-white rounded-md text-sm flex items-center gap-2'><FaDownload /> View Attendance PDF</button>
      </div>
    </div>
  );
}

export default ViewMonthlyAttendance